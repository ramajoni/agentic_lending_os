...
class ApplicationRepository:
    ...
    def record_l1_decision(
        ...
        # Map L1 decision to new application state
    ...
    def get_leaderboard() -> dict:
        ...
        # Pipeline statistics from DAG results
        ...
        # Reviewer productivity from audit_trail
        cursor.execute(
            """
            SELECT 
    ...
    def get_case_drilldown(applicant_id: str) -> Optional[dict]:
        ...
        # Step 2: Automated DAG Verification
        ...
        # Reviewer steps from audit_history
    ...
    def list_users() -> list[dict]:
        ...
        conn = get_db_connection()
        cursor = conn.cursor()
        cursor.execute("SELECT user_id, username, role, full_name, email, created_at FROM users ORDER BY created_at ASC")
        rows = cursor.fetchall()
        conn.close()
